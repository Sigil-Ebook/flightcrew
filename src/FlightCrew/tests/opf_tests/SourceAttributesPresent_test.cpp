...
TEST( SourceAttributesPresentTest, NotAllowedAttributes )
{
    SourceAttributesPresent validator;
    ...
    EXPECT_EQ( message_arguments1[ 1 ], "source" );
}

TEST( SourceAttributesPresentTest, AllowedAttributes )
{
    SourceAttributesPresent validator;
    std::vector<Result> results = validator.ValidateFile(
