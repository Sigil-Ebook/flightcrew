...
TEST( TypeAttributesPresentTest, NotAllowedAttributes )
{
    TypeAttributesPresent validator;
    ...
    EXPECT_EQ( message_arguments1[ 1 ], "type" );
}

TEST( TypeAttributesPresentTest, AllowedAttributes )
{
    TypeAttributesPresent validator;
    std::vector<Result> results = validator.ValidateFile(
