...
#include <stdafx.h>
#include "DCMetadataAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> DCMetadataAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    std::vector< QName > allowed_attributes;
    allowed_attributes.push_back( QName( "id", "" ) );

    QName element_qname( "dc-metadata", OPF_XML_NAMESPACE );
