...
#include <stdafx.h>
#include "SourceAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> SourceAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    ...
    QName element_qname( "source", DC_XML_NAMESPACE );
