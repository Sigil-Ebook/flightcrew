...
#include <stdafx.h>
#include "DescriptionAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> DescriptionAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    ...
    QName element_qname( "description", DC_XML_NAMESPACE );
