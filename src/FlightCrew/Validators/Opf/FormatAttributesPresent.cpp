...
#include <stdafx.h>
#include "FormatAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> FormatAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    std::vector< QName > allowed_attributes;
    allowed_attributes.push_back( QName( "id", "" ) );

    QName element_qname( "format", DC_XML_NAMESPACE );
