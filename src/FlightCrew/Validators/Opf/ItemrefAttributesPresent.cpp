...
#include <stdafx.h>
#include "ItemrefAttributesPresent.h"
#include "Misc/Utilities.h"

namespace FlightCrew
{

std::vector<Result> ItemrefAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    std::vector< QName > allowed_attributes;
    allowed_attributes.push_back( QName( "id", "" ) );
    allowed_attributes.push_back( QName( "idref", "" ) );
    allowed_attributes.push_back( QName( "linear", "" ) );

    QName element_qname( "itemref", OPF_XML_NAMESPACE );
    ...
    mandatory_attributes.push_back( QName( "idref", "" ) );
