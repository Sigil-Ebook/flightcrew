...
#include <stdafx.h>
#include "ManifestAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> ManifestAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    std::vector< QName > allowed_attributes;
    allowed_attributes.push_back( QName( "id", "" ) );

    QName element_qname( "manifest", OPF_XML_NAMESPACE );
