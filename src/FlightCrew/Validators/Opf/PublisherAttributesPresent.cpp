...
#include <stdafx.h>
#include "PublisherAttributesPresent.h"

namespace FlightCrew
{

std::vector<Result> PublisherAttributesPresent::ValidateXml( const xc::DOMDocument &document )
{
    ...
    QName element_qname( "publisher", DC_XML_NAMESPACE );
